...
class CoolParser(ShiftReduceParser, ABC):
    ...
    def __action_table():
        return {
            ...
            (112, G["}"]): ("SHIFT", 113),
            (113, G["error"]): ("REDUCE", G["method -> id ( ) : type { expr }"]),
            (113, G[";"]): ("REDUCE", G["method -> id ( ) : type { expr }"]),
            (114, G[":"]): ("SHIFT", 115),
            (115, G["type"]): ("SHIFT", 116),
            (116, G[","]): ("SHIFT", 117),
            (116, G[")"]): ("REDUCE", G["param-list -> id : type"]),
            (117, G["id"]): ("SHIFT", 114),
            (118, G[")"]): ("REDUCE", G["param-list -> id : type , param-list"]),
            (119, G[")"]): ("SHIFT", 120),
            (120, G[":"]): ("SHIFT", 121),
            (121, G["type"]): ("SHIFT", 122),
            (122, G["{"]): ("SHIFT", 123),
            (123, G["new"]): ("SHIFT", 22),
            (123, G["{"]): ("SHIFT", 10),
            (123, G["id"]): ("SHIFT", 31),
            ...
            (123, G["not"]): ("SHIFT", 30),
            (123, G["("]): ("SHIFT", 11),
            (123, G["false"]): ("SHIFT", 26),
            (123, G["string"]): ("SHIFT", 33),
            (123, G["isvoid"]): ("SHIFT", 24),
            (123, G["let"]): ("SHIFT", 14),
            (123, G["while"]): ("SHIFT", 13),
            (123, G["~"]): ("SHIFT", 27),
            (123, G["case"]): ("SHIFT", 21),
            (124, G["}"]): ("SHIFT", 125),
            (125, G[";"]): ("REDUCE", G["method -> id ( param-list ) : type { expr }"]),
            (125, G["error"]): ("REDUCE", G["method -> id ( param-list ) : type { expr }"]),
            (126, G["type"]): ("SHIFT", 127),
            (127, G["<-"]): ("SHIFT", 128),
            (127, G[";"]): ("REDUCE", G["attribute -> id : type"]),
            (127, G["error"]): ("REDUCE", G["attribute -> id : type"]),
            (128, G["isvoid"]): ("SHIFT", 24),
            (128, G["id"]): ("SHIFT", 31),
            (128, G["true"]): ("SHIFT", 25),
            (128, G["~"]): ("SHIFT", 27),
            (128, G["int"]): ("SHIFT", 34),
            (128, G["{"]): ("SHIFT", 10),
            (128, G["("]): ("SHIFT", 11),
            (128, G["false"]): ("SHIFT", 26),
            (128, G["string"]): ("SHIFT", 33),
            (128, G["not"]): ("SHIFT", 30),
            (128, G["if"]): ("SHIFT", 12),
            (128, G["let"]): ("SHIFT", 14),
            (128, G["new"]): ("SHIFT", 22),
            (128, G["while"]): ("SHIFT", 13),
            (128, G["case"]): ("SHIFT", 21),
            (129, G[";"]): ("REDUCE", G["attribute -> id : type <- expr"]),
            (129, G["error"]): ("REDUCE", G["attribute -> id : type <- expr"]),
            (130, G["}"]): ("SHIFT", 131),
            (131, G["$"]): ("REDUCE", G["class-def -> class type { feature-list }"]),
            (131, G["class"]): ("REDUCE", G["class-def -> class type { feature-list }"]),
            (132, G[";"]): ("SHIFT", 133),
            (132, G["error"]): ("SHIFT", 140),
            (133, G["id"]): ("SHIFT", 4),
            (133, G["}"]): ("REDUCE", G["feature-list -> e"]),
            (134, G["}"]): ("REDUCE", G["feature-list -> attribute ; feature-list"]),
            (135, G["error"]): ("SHIFT", 138),
            (135, G[";"]): ("SHIFT", 136),
            (136, G["id"]): ("SHIFT", 4),
            (136, G["}"]): ("REDUCE", G["feature-list -> e"]),
            (137, G["}"]): ("REDUCE", G["feature-list -> method ; feature-list"]),
            (138, G["id"]): ("SHIFT", 4),
            (138, G["}"]): ("REDUCE", G["feature-list -> e"]),
            (139, G["}"]): ("REDUCE", G["feature-list -> method error feature-list"]),
            (140, G["id"]): ("SHIFT", 4),
            (140, G["}"]): ("REDUCE", G["feature-list -> e"]),
            (141, G["}"]): ("REDUCE", G["feature-list -> attribute error feature-list"]),
            (142, G["type"]): ("SHIFT", 143),
            (143, G["{"]): ("SHIFT", 144),
            (144, G["id"]): ("SHIFT", 4),
            (144, G["}"]): ("REDUCE", G["feature-list -> e"]),
            (145, G["}"]): ("SHIFT", 146),
            (146, G["$"]): ("REDUCE", G["class-def -> class type inherits type { feature-list }"]),
            (146, G["class"]): ("REDUCE", G["class-def -> class type inherits type { feature-list }"]),
            (147, G["$"]): ("OK", None),
            (148, G["$"]): ("REDUCE", G["program -> class-list"]),
            (149, G["class"]): ("SHIFT", 1),
            (149, G["$"]): ("REDUCE", G["class-list -> class-def"]),
            (150, G["$"]): ("REDUCE", G["class-list -> class-def class-list"]),
        }
    ...
    def __goto_table():
        return {
            ...
            (110, G["factor"]): 56,
            (110, G["block"]): 111,
            (117, G["param-list"]): 118,
            (123, G["arith"]): 38,
            (123, G["term"]): 53,
            (123, G["atom"]): 43,
            (123, G["function-call"]): 35,
            (123, G["factor"]): 56,
            (123, G["expr"]): 124,
            (123, G["comp"]): 37,
            (128, G["term"]): 53,
