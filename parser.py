...
class CoolParser(ShiftReduceParser, ABC):
    ...
    def __action_table():
        return {
            ...
            (47, G["~"]): ("SHIFT", 37),
            (48, G["-"]): ("SHIFT", 56),
            (48, G["="]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["loop"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["}"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["fi"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["pool"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G[")"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G[","]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["in"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["then"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["else"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["of"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["<="]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G[";"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["<"]): ("REDUCE", G["comp -> comp < arith"]),
            (48, G["+"]): ("SHIFT", 49),
            ...
            (49, G["true"]): ("SHIFT", 35),
            (50, G["*"]): ("SHIFT", 51),
            (50, G["="]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["loop"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["}"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["fi"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["pool"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["+"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G[")"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["-"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G[","]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["in"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["then"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["else"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["of"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["<="]): ("REDUCE", G["arith -> arith + term"]),
            (50, G[";"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["<"]): ("REDUCE", G["arith -> arith + term"]),
            (50, G["/"]): ("SHIFT", 53),
            ...
            (51, G["~"]): ("SHIFT", 37),
            (51, G["true"]): ("SHIFT", 35),
            (52, G["="]): ("REDUCE", G["term -> term * factor"]),
            (52, G["loop"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["}"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["fi"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["pool"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["+"]): ("REDUCE", G["term -> term * factor"]),
            (52, G[")"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["-"]): ("REDUCE", G["term -> term * factor"]),
            (52, G[","]): ("REDUCE", G["term -> term * factor"]),
            (52, G["in"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["*"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["then"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["/"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["else"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["of"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["<="]): ("REDUCE", G["term -> term * factor"]),
            (52, G[";"]): ("REDUCE", G["term -> term * factor"]),
            (52, G["<"]): ("REDUCE", G["term -> term * factor"]),
            (53, G["false"]): ("SHIFT", 36),
            ...
            (56, G["~"]): ("SHIFT", 37),
            (56, G["true"]): ("SHIFT", 35),
            (57, G["="]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["loop"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["}"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["fi"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["pool"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["+"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G[")"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["-"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G[","]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["in"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["then"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["else"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["of"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["<="]): ("REDUCE", G["arith -> arith - term"]),
            (57, G[";"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["<"]): ("REDUCE", G["arith -> arith - term"]),
            (57, G["*"]): ("SHIFT", 51),
            ...
            (60, G["-"]): ("SHIFT", 56),
            (60, G["+"]): ("SHIFT", 49),
            (60, G["="]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["loop"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["}"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["fi"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["pool"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G[")"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G[","]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["in"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["then"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["else"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["of"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["<="]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G[";"]): ("REDUCE", G["comp -> comp <= arith"]),
            (60, G["<"]): ("REDUCE", G["comp -> comp <= arith"]),
            (61, G["false"]): ("SHIFT", 36),
            ...
            (61, G["~"]): ("SHIFT", 37),
            (62, G["="]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["loop"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["}"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["fi"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["pool"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G[")"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G[","]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["in"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["then"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["else"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["of"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["<="]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G[";"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["<"]): ("REDUCE", G["comp -> comp = arith"]),
            (62, G["-"]): ("SHIFT", 56),
            (62, G["+"]): ("SHIFT", 49),
            (63, G["="]): ("REDUCE", G["comp -> arith"]),
            (63, G["loop"]): ("REDUCE", G["comp -> arith"]),
            (63, G["}"]): ("REDUCE", G["comp -> arith"]),
            (63, G["pool"]): ("REDUCE", G["comp -> arith"]),
            (63, G[")"]): ("REDUCE", G["comp -> arith"]),
            (63, G["in"]): ("REDUCE", G["comp -> arith"]),
            (63, G[","]): ("REDUCE", G["comp -> arith"]),
            (63, G["then"]): ("REDUCE", G["comp -> arith"]),
            (63, G["else"]): ("REDUCE", G["comp -> arith"]),
            (63, G["fi"]): ("REDUCE", G["comp -> arith"]),
            (63, G["<="]): ("REDUCE", G["comp -> arith"]),
            (63, G[";"]): ("REDUCE", G["comp -> arith"]),
            (63, G["of"]): ("REDUCE", G["comp -> arith"]),
            (63, G["<"]): ("REDUCE", G["comp -> arith"]),
            (63, G["-"]): ("SHIFT", 56),
            (63, G["+"]): ("SHIFT", 49),
            (64, G[")"]): ("SHIFT", 65),
            ...
            (139, G["}"]): ("SHIFT", 140),
            (140, G["class"]): ("REDUCE", G["class-def -> class type inherits type { feature-list }"]),
            (140, G["$"]): ("REDUCE", G["class-def -> class type inherits type { feature-list }"]),
            (141, G["$"]): ("OK", None),
            (142, G["$"]): ("REDUCE", G["program -> class-list"]),
            (143, G["class"]): ("SHIFT", 1),
            (143, G["$"]): ("REDUCE", G["class-list -> class-def"]),
            (144, G["$"]): ("REDUCE", G["class-list -> class-def class-list"]),
        }
