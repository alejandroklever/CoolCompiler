...
class CoolParser(ShiftReduceParser, ABC):
    ...
    def __action_table(self):
        ...
        return {
            ...
            (38, G["="]): ("REDUCE", AttributeProduction(G["atom"], Sentence(G["function-call"]), [lambda s: s[1]])),
            (38, G["}"]): ("REDUCE", AttributeProduction(G["atom"], Sentence(G["function-call"]), [lambda s: s[1]])),
            (39, G["in"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G[")"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["+"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["-"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G[","]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["*"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["then"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["/"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["of"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["else"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["<"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["fi"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["<="]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G[";"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["="]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["loop"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["pool"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (39, G["}"]): ("REDUCE", AttributeProduction(G["factor"], Sentence(G["~"], G["factor"]), [lambda s: IsVoidNode(s[2])])),
            (40, G["."]): ("SHIFT", 41),
            ...
            (128, G["class"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["{"], G["}"]), [lambda s: ClassDeclarationNode(s[2], [])])),
            (128, G["$"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["{"], G["}"]), [lambda s: ClassDeclarationNode(s[2], [])])),
            (129, G["}"]): ("SHIFT", 130),
            (130, G["class"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["{"], G["feature-list"], G["}"]), [lambda s: ClassDeclarationNode(s[2], s[4])])),
            (130, G["$"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["{"], G["feature-list"], G["}"]), [lambda s: ClassDeclarationNode(s[2], s[4])])),
            (131, G[";"]): ("SHIFT", 132),
            (132, G["id"]): ("SHIFT", 4),
            (132, G["}"]): ("REDUCE", AttributeProduction(G["feature-list"], Sentence(G["attribute"], G[";"]), [lambda s: [s[1]]])),
            (133, G["}"]): ("REDUCE", AttributeProduction(G["feature-list"], Sentence(G["attribute"], G[";"], G["feature-list"]), [lambda s: [s[1]] + s[3]])),
            (134, G[";"]): ("SHIFT", 135),
            (135, G["id"]): ("SHIFT", 4),
            (135, G["}"]): ("REDUCE", AttributeProduction(G["feature-list"], Sentence(G["method"], G[";"]), [lambda s: [s[1]]])),
            (136, G["}"]): ("REDUCE", AttributeProduction(G["feature-list"], Sentence(G["method"], G[";"], G["feature-list"]), [lambda s: [s[1]] + s[3]])),
            (137, G["{"]): ("SHIFT", 142),
            (137, G["type"]): ("SHIFT", 138),
            (138, G["{"]): ("SHIFT", 139),
            (139, G["id"]): ("SHIFT", 4),
            (140, G["}"]): ("SHIFT", 141),
            (141, G["class"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["inherits"], G["type"], G["{"], G["feature-list"], G["}"]), [lambda s: ClassDeclarationNode(s[2], s[6], s[4])])),
            (141, G["$"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["inherits"], G["type"], G["{"], G["feature-list"], G["}"]), [lambda s: ClassDeclarationNode(s[2], s[6], s[4])])),
            (142, G["}"]): ("SHIFT", 143),
            (143, G["$"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["inherits"], G["{"], G["}"]), [lambda s: ClassDeclarationNode(s[2], [], s[4])])),
            (143, G["class"]): ("REDUCE", AttributeProduction(G["class-def"], Sentence(G["class"], G["type"], G["inherits"], G["{"], G["}"]), [lambda s: ClassDeclarationNode(s[2], [], s[4])])),
            (144, G["$"]): ("OK", None),
            (145, G["$"]): ("REDUCE", AttributeProduction(G["program"], Sentence(G["class-set"]), [lambda s: ProgramNode(s[1])])),
            (146, G["class"]): ("SHIFT", 1),
            (146, G["$"]): ("REDUCE", AttributeProduction(G["class-set"], Sentence(G["class-def"]), [lambda s: [s[1]]])),
            (147, G["$"]): ("REDUCE", AttributeProduction(G["class-set"], Sentence(G["class-def"], G["class-set"]), [lambda s: [s[1]] + s[2]])),
        }
